...
export default function Landing() {
  ...
  return (
    <div>
        ...
        <div className='max-w-7xl mx-auto sm:block md:hidden'>
          <div className='h-[60px] content-start mx-8 mb-10 grid grid-flow-row-dense grid-cols-3 grid-rows-3 border border-[#C6C6C6] pl-2  rounded-xl mt-10 lg:max-w-[400px] md:max-w-[400px] sm:max-w-[400px]' >
                      <input
                        onChange={(e)=>setSearchText(e.target.value)}
                        value={searchText}
                        className='text-left content-start h-[58px]  col-span-2 focus:outline-none pr-2'
